<template>
    <b-modal ref="loginModal" id="modal-login" title="Please create an account to create todo lists" hide-footer no-close-on-esc no-close-on-backdrop hide-header-close>
      ...
      <b-form @submit="onSubmit" class="w-100">
        ...
        <b-form-group label="Password:" label-for="form-pwd-input">
            ...
            <b-button-group>
                ...
                <b-button type="reset" @click="goLogin()" variant="info">I already have an account</b-button>
            </b-button-group>
      </b-form>
    </b-modal>
</template>
...
export default {
    ...
    methods: {
        ...
        tryCreate(payload){
            const path = `http://localhost:5001/api/account`;
